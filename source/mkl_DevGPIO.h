 ...
 *                            Versão 2.0:
 *                             ++ Guilherme Souza da Silva <gsds@icomp.ufam.edu.br>
 *
 * @section     LICENSE
 *
...
typedef enum {
	gpio_PTA1 = 1 | gpio_GPIOA, gpio_PTA2 = 2 | gpio_GPIOA, gpio_PTA4 = 4
			| gpio_GPIOA, gpio_PTA5 = 5 | gpio_GPIOA, gpio_PTA12 = 12
			| gpio_GPIOA, gpio_PTA13 = 13 | gpio_GPIOA, gpio_PTA17 = 17
			| gpio_GPIOA, gpio_PTB0 = 0 | gpio_GPIOB, gpio_PTB1 = 1
			| gpio_GPIOB, gpio_PTB2 = 2 | gpio_GPIOB, gpio_PTB3 = 3
			| gpio_GPIOB, gpio_PTB8 = 8 | gpio_GPIOB, gpio_PTB9 = 9
			| gpio_GPIOB, gpio_PTB10 = 10 | gpio_GPIOB, gpio_PTB11 = 11
			| gpio_GPIOB, gpio_PTB18 = 18 | gpio_GPIOB, gpio_PTB19 = 19
			| gpio_GPIOB, gpio_PTC0 = 0 | gpio_GPIOC, gpio_PTC1 = 1
			| gpio_GPIOC, gpio_PTC2 = 2 | gpio_GPIOC, gpio_PTC3 = 3
			| gpio_GPIOC, gpio_PTC4 = 4 | gpio_GPIOC, gpio_PTC5 = 5
			| gpio_GPIOC, gpio_PTC6 = 6 | gpio_GPIOC, gpio_PTC7 = 7
			| gpio_GPIOC, gpio_PTC8 = 8 | gpio_GPIOC, gpio_PTC9 = 9
			| gpio_GPIOC, gpio_PTC10 = 10 | gpio_GPIOC, gpio_PTC11 = 11
			| gpio_GPIOC, gpio_PTC12 = 12 | gpio_GPIOC, gpio_PTC13 = 13
			| gpio_GPIOC, gpio_PTC14 = 14 | gpio_GPIOC, gpio_PTC15 = 15
			| gpio_GPIOC, gpio_PTC16 = 16 | gpio_GPIOC, gpio_PTC17 = 17
			| gpio_GPIOC, gpio_PTD0 = 0 | gpio_GPIOD, gpio_PTD1 = 1
			| gpio_GPIOD, gpio_PTD2 = 2 | gpio_GPIOD, gpio_PTD3 = 3
			| gpio_GPIOD, gpio_PTD4 = 4 | gpio_GPIOD, gpio_PTD5 = 5
			| gpio_GPIOD, gpio_PTD6 = 6 | gpio_GPIOD, gpio_PTD7 = 7
			| gpio_GPIOD, gpio_PTE0 = 0 | gpio_GPIOE, gpio_PTE1 = 1
			| gpio_GPIOE, gpio_PTE3 = 3 | gpio_GPIOE, gpio_PTE4 = 4
			| gpio_GPIOE, gpio_PTE5 = 5 | gpio_GPIOE, gpio_PTE20 = 20
			| gpio_GPIOE, gpio_PTE21 = 21 | gpio_GPIOE, gpio_PTE22 = 22
			| gpio_GPIOE, gpio_PTE23 = 23 | gpio_GPIOE, gpio_PTE29 = 29
			| gpio_GPIOE
} gpio_Pin;
 ...
 */
typedef enum {
	gpio_pullNoneResistor = 0, gpio_pullUpResistor = 3
} gpio_PullResistor;
 ...
 *             +fn writeBit(data);
 */
class mkl_DevGPIO : public Callback {
public:
	/*!
	 * Construtor padrão classe.
	 */
	mkl_DevGPIO();
	explicit mkl_DevGPIO(gpio_Pin pin);
	/*!
	...
	void toogleBit();
	const mkl_DevGPIO &operator=(const int bit);
	/*!
